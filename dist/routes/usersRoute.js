...
router.get("/user-details/:userId", users_1.getUserDetails);
router.delete("/delete-account/:id", auth_1.isAuthenticated, users_1.deleteUser);
router.put("/update-user/:userId", auth_1.isAuthenticated, users_1.updateUserInfo);
